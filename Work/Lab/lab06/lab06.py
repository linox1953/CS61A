...
class Account:
    ...
    def deposit(self, amount):
        ...
        """
        self.update_transactions(self.balance, self.balance+amount)
    ...
    def withdraw(self, amount):
        ...
        if amount > self.balance:
            self.update_transactions(self.balance, self.balance)
            return 'Insufficient funds'
        self.update_transactions(self.balance, self.balance-amount)
        self.balance = self.balance - amount
        return self.balance

    def update_transactions(self, before, after):
        self.transactions += [Transaction(self.id, before, after)]
        self.id += 1
...
def make_change(amount, coins):
    ...
    if amount < smallest:
        ...
        res = make_change(amount-smallest, rest)
        if res:
            return [smallest] + res
        else:
